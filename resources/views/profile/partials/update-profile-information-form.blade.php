<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="akun_repo" :value="__('akun_repo')" />
            <x-text-input id="akun_repo" name="akun_repo" type="text" class="mt-1 block w-full" :value="old('akun_repo', $user->akun_repo)" required autofocus autocomplete="akun_repo" />
            <x-input-error class="mt-2" :messages="$errors->get('akun_repo')" />
        </div>
